...
from .views import RegisterView,LoginView,ForgotPasswordView,ResetPasswordView,OTPVerificationView,ForgotPasswordView,ResetPasswordView,ProductPageView
